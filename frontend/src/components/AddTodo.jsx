...
export default function AddTodo({setShowAdd}) {
  ...
  return (
    ...
    my-[0.5%] px-[3%]'  key={`todo_addtodo`} >
      <button onClick={handleSubmit} className='absolute left-[0%] cursor-pointer'><AddIcon /></button>
       <input className='flex col-span-2 hover:bg-gray-200 justify-items-start text-left' 
